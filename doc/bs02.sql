...
from
    ...
    on sc.TPID=so.TPID
    left join (
    select OrderID, ExpressFee from origindb.dp_myshow__s_orderdelivery where OrderDeliveryID is not null and CreateTime>='2017-09-30' and CreateTime<'2017-12-01'
